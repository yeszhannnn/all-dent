...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute left-[-12px] top-1/2 -translate-y-1/2 h-8 w-8 rounded-full z-10", className)}
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute right-[-12px] top-1/2 -translate-y-1/2 h-8 w-8 rounded-full z-10", className)}
